...
> Aleut Federal company context lives in the **aleut-federal-context** Skill (auto-invoked for AF-related questions). See the user-invocable `create-viz` skill for federal-audience visualization rules (Section 508, CUI banners, no agency logos, methodology footers, accessible PDFs).
