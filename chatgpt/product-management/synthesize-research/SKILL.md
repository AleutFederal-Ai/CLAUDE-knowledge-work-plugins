...
> Aleut Federal company context lives in the **aleut-federal-context** Skill (auto-invoked for AF-related questions). See `design/research-synthesis` for federal-research-synthesis rules (PRA, Privacy Act, federal-employee identifiability, CDRL deliverables) — they apply equally here.
