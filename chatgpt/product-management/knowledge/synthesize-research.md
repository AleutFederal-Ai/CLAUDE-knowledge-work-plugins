...
> **What this skill does:** Synthesize user research from interviews, surveys, and feedback into structured insights. Use when you have a pile of interview notes, survey responses, or support tickets to make sense of, need to extract themes and rank findings by frequency and impact, or want to turn raw feedback into roadmap recommendations.

# Synthesize Research — Aleut Federal

> Aleut Federal company context lives in `ALEUT-FEDERAL-CONTEXT.md` (uploaded as `00-ALEUT-FEDERAL-CONTEXT.md`). See `design/research-synthesis` for federal-research-synthesis rules (PRA, Privacy Act, federal-employee identifiability, CDRL deliverables) — they apply equally here.
