...
> Aleut Federal company context lives in the **aleut-federal-context** Skill (auto-invoked for AF-related questions). For federal BD competitive intel (against named primes on named pursuits), prefer `sales/competitive-intelligence` — it's tailored for SAM.gov / USAspending / vehicle / set-aside / CPARS analysis. This skill is best for **product / program** competition: feature-level positioning, capability differentiation.
