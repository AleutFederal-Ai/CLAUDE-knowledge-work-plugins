...
> **What this skill does:** Analyze the Aleut Federal capture / BD pipeline through Shipley capture stages — prioritize pursuits, flag bid/no-bid hygiene, identify single-threaded teams, surface compliance gates (FAR 52.219-14, CMMC level, bonding, clearances), audit incumbency and recompete coverage. Use for weekly capture review, gate decisions, BD-leader portfolio review, or quarterly bid/no-bid retrospective.
