...
> Aleut Federal company context lives in the **aleut-federal-context** Skill (auto-invoked for AF-related questions). See `search-strategy` and `knowledge-synthesis` for federal-aware source routing and CUI/privilege handling.
